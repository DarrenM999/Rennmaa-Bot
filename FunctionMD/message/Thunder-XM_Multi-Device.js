...
${left}${left}⚙️ *Prefix:*
${left}${left} Multi Prefix
${left}${left}${taipye} Baileys-md
${left}${left}🩸 *Version:* ${Options.info.version} 
${left}${left}${runtz}    
${left}${left}  ${runtime(process.uptime())}          
${left}${closing} 
${left}${opening}🤖 *Hosting Specs* ${opening2}
${left}${left}
${left}${left}📟 *RAM:* 
${left}${left}32 GB / 32 Gigabytes
${left}${left}💾 *Storage:* 
${left}${left}1 TB / 1 Terabytes
${left}${left}🖥️ *Processor:*
${left}${left}Intel Core i9-12900KS ( 5.5 GHz )
${left}${left}📀 *VGA Card:*
${left}${left}Nvidia GeForce RTX™ 3090 Ti
${left}${left}*OS:*
${left}${left}Linux 5.17.5
${left}${closing2} 
${left} ${readMore}
${left}${borderlist}
${left}${left} LIST MENU 📄        
${left}${borderlistend}
${bracketmenu} 📁️ Default ${F}
...
${branch}${LETT++} ${prefix}infogroup
${branch}${LETT++} ${prefix}linkgroup
${branch}${LETT++} ${prefix}announcement
${branch}${LETT++} ${prefix}tagall
${bracketmenu} 🏞️ RPG ${F}
...
${branch}${LETT++} ${prefix}casino
${branch}${LETT++} ${prefix}monthly
${branch}${LETT++} ${prefix}open <create> <count>
${branch}${LETT++} ${prefix}buy <item> count>
${branch}${LETT++} ${prefix}sell <item> count>
${branch}${LETT++} ${prefix}transfer <type> <amount> <@tag>
${branch}${LETT++} ${prefix}tf <type> <amount> <@tag>
${bracketmenu} 🪙 Exp & Limit ${F}
${branch}${LETT++} ${prefix}levelup
${branch}${LETT++} ${prefix}daily
${branch}${LETT++} ${prefix}claim
${bracketmenu} 🎞 Image ${F}
${branch}${LETT++} ${prefix}8bit (reply) 
${branch}${LETT++} ${prefix}bintang <teks> 
${branch}${LETT++} ${prefix}bokehtext <teks> 
${branch}${LETT++} ${prefix}cewek
${branch}${LETT++} ${prefix}circle (reply) 
${branch}${LETT++} ${prefix}cod <teks|teks> 
${branch}${LETT++} ${prefix}ppcouple
${branch}${LETT++} ${prefix}ppcp
${branch}${LETT++} ${prefix}cowok
${branch}${LETT++} ${prefix}cup1 <teks> 
${branch}${LETT++} ${prefix}darkjokes
${branch}${LETT++} ${prefix}estetik 
${branch}${LETT++} ${prefix}futureneon <teks> 
${branch}${LETT++} ${prefix}glasses  
${branch}${LETT++} ${prefix}helloween <text> 
${branch}${LETT++} ${prefix}heroml <nama> 
${branch}${LETT++} ${prefix}image <query> 
${branch}${LETT++} ${prefix}pinterest <query> 
${branch}${LETT++} ${prefix}jahy  
${branch}${LETT++} ${prefix}kpop <query>
${branch}${LETT++} ${prefix}ktp <nik|prov|kabu|name|ttl|jk|jl|rtrw|lurah|camat|agama|nikah|kerja|warga|until|url> 
${branch}${LETT++} ${prefix}leavetext <teks> 
${branch}${LETT++} ${prefix}logomarvel <teks|teks> 
${branch}${LETT++} ${prefix}makanan
${branch}${LETT++} ${prefix}manga  
${branch}${LETT++} ${prefix}marvellogo <text|text>
${branch}${LETT++} ${prefix}mem
${branch}${LETT++} ${prefix}metalicglow <teks> 
${branch}${LETT++} ${prefix}neon1 <teks> 
${branch}${LETT++} ${prefix}pinterest <query> 
${branch}${LETT++} ${prefix}pinterest2 <query> 
${branch}${LETT++} ${prefix}quotesimg <teks> 
${branch}${LETT++} ${prefix}spiderman <teks|teks> 
${branch}${LETT++} ${prefix}splaybutton <teks>
${branch}${LETT++} ${prefix}summer <teks> 
${branch}${LETT++} ${prefix}trash (reply) 
${branch}${LETT++} ${prefix}wallpaper  
${branch}${LETT++} ${prefix}wallpaperq <query> 
${branch}${LETT++} ${prefix}wpcyberspace
${branch}${LETT++} ${prefix}wpteknologi
${branch}${LETT++} ${prefix}wpprogramming
${branch}${LETT++} ${prefix}wppegunungan
${branch}${LETT++} ${prefix}wpmobile  
${branch}${LETT++} ${prefix}wpnsfwmobile  
${branch}${LETT++} ${prefix}zettairyouiki  
${branch}${LETT++} ${prefix}zettairyouiki  
${bracketmenu} 🎥 Video ${F}
${branch}${LETT++} ${prefix}intromaker
${branch}${LETT++} ${prefix}jedagjedug
${branch}${LETT++} ${prefix}pmvmaker
${branch}${LETT++} ${prefix}gmvmaker
${branch}${LETT++} ${prefix}amvmaker
${bracketmenu} 🖌️️ TextPro ${F}
...
${branch}${LETT++} ${prefix}advancedglow <teks> 
${branch}${LETT++} ${prefix}aglitertext 
${branch}${LETT++} ${prefix}amongus <teks> 
${branch}${LETT++} ${prefix}attp <teks>
${branch}${LETT++} ${prefix}attp2 
${branch}${LETT++} ${prefix}attp3 <teks>
${branch}${LETT++} ${prefix}avengers <teks|teks> 
${branch}${LETT++} ${prefix}banner <text> 
${branch}${LETT++} ${prefix}logo <text> 
${branch}${LETT++} ${prefix}battlefield <teks|teks> 
${branch}${LETT++} ${prefix}bloodtext <teks> 
${branch}${LETT++} ${prefix}bplogo <teks> 
${branch}${LETT++} ${prefix}breakwall <teks> 
${branch}${LETT++} ${prefix}burningtext 
${branch}${LETT++} ${prefix}burnpaper <teks> 
${branch}${LETT++} ${prefix}carbontext <teks> 
${branch}${LETT++} ${prefix}cloudtext <teks> 
${branch}${LETT++} ${prefix}coffecup <teks> 
${branch}${LETT++} ${prefix}coffetext <teks> 
${branch}${LETT++} ${prefix}s
${branch}${LETT++} ${prefix}sgif
${branch}${LETT++} ${prefix}sticker <teks> 
${branch}${LETT++} ${prefix}ctrigger <text> 
${branch}${LETT++} ${prefix}crossfire <teks> 
${branch}${LETT++} ${prefix}cstahta <teks> 
${branch}${LETT++} ${prefix}ctrigger <text> 
${branch}${LETT++} ${prefix}darkneon <teks> 
${branch}${LETT++} ${prefix}dropwater <teks> 
${branch}${LETT++} ${prefix}dropwater2 <teks> 
${branch}${LETT++} ${prefix}editodserti <teks>
${branch}${LETT++} ${prefix}ephoto <effect|teks> 
${branch}${LETT++} ${prefix}ephoto <effect|teks> 
${branch}${LETT++} ${prefix}fbplaybutton <teks> 
${branch}${LETT++} ${prefix}fflogo <teks> 
${branch}${LETT++} ${prefix}fflogo2 <teks> 
${branch}${LETT++} ${prefix}ffserti1 <teks> 
${branch}${LETT++} ${prefix}ffserti2 <teks>
${branch}${LETT++} ${prefix}firetext <teks> 
${branch}${LETT++} ${prefix}firework <teks> 
${branch}${LETT++} ${prefix}flametext <teks> 
${branch}${LETT++} ${prefix}flamming <teks> 
${branch}${LETT++} ${prefix}football <nama|nomer> 
${branch}${LETT++} ${prefix}gaminglogo <teks> 
${branch}${LETT++} ${prefix}haramserti teks
${branch}${LETT++} ${prefix}gayserti <teks>
${branch}${LETT++} ${prefix}getexif
${branch}${LETT++} ${prefix}glitch teks|teks
${branch}${LETT++} ${prefix}glitertext <teks|teks> 
${branch}${LETT++} ${prefix}glow <teks> 
${branch}${LETT++} ${prefix}glowtext <teks> 
${branch}${LETT++} ${prefix}glowtext2 <teks> 
${branch}${LETT++} ${prefix}gneon <teks>
${branch}${LETT++} ${prefix}goldtext <teks> 
${branch}${LETT++} ${prefix}gplaybutton <teks> 
${branch}${LETT++} ${prefix}gradient <teks> 
${branch}${LETT++} ${prefix}greyscale (reply) 
${branch}${LETT++} ${prefix}gsuggesti <teks|teks|teks> 
${branch}${LETT++} ${prefix}gtattp <teks|teks> 
${branch}${LETT++} ${prefix}harrypotter <teks> 
${branch}${LETT++} ${prefix}hekerserti <teks>
${branch}${LETT++} ${prefix}hitler (reply) 
${branch}${LETT++} ${prefix}honey <teks> 
${branch}${LETT++} ${prefix}horny (caption|reply media) 
${branch}${LETT++} ${prefix}invert (reply) 
${branch}${LETT++} ${prefix}joke (reply) 
${branch}${LETT++} ${prefix}jokerlogo <teks> 
${branch}${LETT++} ${prefix}kiss
${branch}${LETT++} ${prefix}lionlogo <teks|teks> 
${branch}${LETT++} ${prefix}logobp <teks>
${branch}${LETT++} ${prefix}lolbanner <teks> 
${branch}${LETT++} ${prefix}lovecoffe <teks> 
${branch}${LETT++} ${prefix}naruto <teks> 
${branch}${LETT++} ${prefix}neon <teks> 
${branch}${LETT++} ${prefix}neontext <teks> 
${branch}${LETT++} ${prefix}nexustext <teks|teks|teks> 
${branch}${LETT++} ${prefix}ninjalogo <teks|teks> 
${branch}${LETT++} ${prefix}pantaitext <teks> 
${branch}${LETT++} ${prefix}phcommand <name|pesan>
${branch}${LETT++} ${prefix}phcomment <username|command> 
${branch}${LETT++} ${prefix}phlogo <text|text>
${branch}${LETT++} ${prefix}photooxy <effect|teks> 
${branch}${LETT++} ${prefix}picture (reply) 
${branch}${LETT++} ${prefix}gplaybutton <teks>
${branch}${LETT++} ${prefix}pubglogo teks|teks
${branch}${LETT++} ${prefix}pubglogo <teks|teks> 
${branch}${LETT++} ${prefix}pubgserti <teks>
${branch}${LETT++} ${prefix}pubgserti2 <teks>
${branch}${LETT++} ${prefix}quotemaker (tulisan)|(name)
${branch}${LETT++} ${prefix}rainbowglow <teks> 
${branch}${LETT++} ${prefix}rainbowshine <teks> 
${branch}${LETT++} ${prefix}realisticcloud 
${branch}${LETT++} ${prefix}run (reply media) 
${branch}${LETT++} ${prefix}sandw <teks>
${branch}${LETT++} ${prefix}sbburn <teks> 
${branch}${LETT++} ${prefix}semoji2 <teks>
${branch}${LETT++} ${prefix}semoji3 [tipe] <emoji>
${branch}${LETT++} ${prefix}sepia (reply) 
${branch}${LETT++} ${prefix}sfire 
${branch}${LETT++} ${prefix}stickerfire
${branch}${LETT++} ${prefix}shaketext 
${branch}${LETT++} ${prefix}stikermeme <teks atas>|<teks bawah> 
${branch}${LETT++} ${prefix}smim <reply imagenya>
${branch}${LETT++} ${prefix}smim2
${branch}${LETT++} ${prefix}smim3
${branch}${LETT++} ${prefix}smooke <teks> 
${branch}${LETT++} ${prefix}snowtext <teks|teks> 
${branch}${LETT++} ${prefix}snowtext2 <teks> 
${branch}${LETT++} ${prefix}circle
${branch}${LETT++} ${prefix}sticker
${branch}${LETT++} ${prefix}stikerline <url> 
${branch}${LETT++} ${prefix}stikerly <pencarian> 
${branch}${LETT++} ${prefix}stikermeme <teks atas>|<teks bawah> 
${branch}${LETT++} ${prefix}stag <reply sticker>
${branch}${LETT++} ${prefix}stickertag <replay sticker>
${branch}${LETT++} ${prefix}stikertag <reply sticker>
${branch}${LETT++} ${prefix}stikertelegram <url> 
${branch}${LETT++} ${prefix}stickfilter (caption|reply media) 
${branch}${LETT++} ${prefix}stickmaker (caption|reply media) 
${branch}${LETT++} ${prefix}stikerline <url> 
${branch}${LETT++} ${prefix}stikerly <pencarian> 
${branch}${LETT++} ${prefix}stikertelegram <url> 
${branch}${LETT++} ${prefix}style <query|teks> 
${branch}${LETT++} ${prefix}surgaserti <teks>
${branch}${LETT++} ${prefix}tahta <teks> 
${branch}${LETT++} ${prefix}inu <teks> 
${branch}${LETT++} ${prefix}telestick <teks>
${branch}${LETT++} ${prefix}text3d <teks>
${branch}${LETT++} ${prefix}text3d2 <teks>
${branch}${LETT++} ${prefix}textburn <teks> 
${branch}${LETT++} ${prefix}thundertext <teks> 
${branch}${LETT++} ${prefix}toimg (reply)
${branch}${LETT++} ${prefix}tololserti <teks> 
${branch}${LETT++} ${prefix}tovideo (reply stiker)
${branch}${LETT++} ${prefix}toxictext <teks> 
${branch}${LETT++} ${prefix}trigger
${branch}${LETT++} ${prefix}trumpcomment <teks> 
${branch}${LETT++} ${prefix}ttp <teks>
${branch}${LETT++} ${prefix}ttp2 
${branch}${LETT++} ${prefix}ttp3 <teks>
${branch}${LETT++} ${prefix}ttp4 <teks>
${branch}${LETT++} ${prefix}ttp5 <teks>
${branch}${LETT++} ${prefix}ttp6 <teks>
${branch}${LETT++} ${prefix}ttpdark <teks> 
${branch}${LETT++} ${prefix}ultah <teks> 
${branch}${LETT++} ${prefix}underwater <teks> 
${branch}${LETT++} ${prefix}valorant <teks|teks|teks> 
${branch}${LETT++} ${prefix}wallgravity <teks|teks> 
${branch}${LETT++} ${prefix}wanted (reply) 
${branch}${LETT++} ${prefix}warface <teks> 
${branch}${LETT++} ${prefix}wasted
${branch}${LETT++} ${prefix}water <teks>
${branch}${LETT++} ${prefix}whitecube <teks> 
${branch}${LETT++} ${prefix}wm <packname>|<author>
${branch}${LETT++} ${prefix}wolflogo <text|text>
${branch}${LETT++} ${prefix}wolfmetal <teks> 
${branch}${LETT++} ${prefix}wooden <teks> 
${branch}${LETT++} ${prefix}woodenboard <teks> 
${branch}${LETT++} ${prefix}woodtext <teks> 
${bracketmenu} ℹ️ Information ${F}
${branch}${LETT++} ${prefix}owner
${branch}${LETT++} ${prefix}donate
${branch}${LETT++} ${prefix}botinfo
${branch}${LETT++} ${prefix}runtime
${branch}${LETT++} ${prefix}speed
${branch}${LETT++} ${prefix}ping    
${branch}${LETT++} ${prefix}profile
${branch}${LETT++} ${prefix}inventori
${branch}${LETT++} ${prefix}leaderboard
${branch}${LETT++} ${prefix}premiumlist
${branch}${LETT++} ${prefix}grouplist
...
${branch}${LETT++} ${prefix}milf
${branch}${LETT++} ${prefix}oneesan
${branch}${LETT++} ${prefix}hentai
${bracketmenu} Sound 🔊 ${F}
${branch}${LETT++} ${prefix}sound1
${branch}${LETT++} ${prefix}sound2
${branch}${LETT++} ${prefix}sound3
${branch}${LETT++} ${prefix}sound4
${branch}${LETT++} ${prefix}sound5
${branch}${LETT++} ${prefix}sound6
${branch}${LETT++} ${prefix}sound7
${branch}${LETT++} ${prefix}sound8
${branch}${LETT++} ${prefix}sound9
${branch}${LETT++} ${prefix}sound10
...
${bracketmenu} Manhwa ${F}
${branch}${LETT++} ${prefix}manhwa18
...
${bracketmenu} 📱Fun ${F}
${branch}${LETT++} ${prefix}angka <0-9>
${branch}${LETT++} ${prefix}caklontong
${branch}${LETT++} ${prefix}cantikcek 
${branch}${LETT++} ${prefix}cari <query>
${branch}${LETT++} ${prefix}casino <jumlah>
${branch}${LETT++} ${prefix}dadu
${branch}${LETT++} ${prefix}dadu2
${branch}${LETT++} ${prefix}dare
${branch}${LETT++} ${prefix}family100
${branch}${LETT++} ${prefix}gantengcek 
${branch}${LETT++} ${prefix}gaycek 
${branch}${LETT++} ${prefix}iqtest
${branch}${LETT++} ${prefix}math2
${branch}${LETT++} ${prefix}siapakahaku
${branch}${LETT++} ${prefix}slot  
${branch}${LETT++} ${prefix}suit
${branch}${LETT++} ${prefix}tololcek 
${branch}${LETT++} ${prefix}truth
${branch}${LETT++} ${prefix}twister
...
${branch}${LETT++} ${prefix}premiumadd
${branch}${LETT++} ${prefix}premiumdel
${branch}${LETT++} ${prefix}stop
${branch}${LETT++} ${prefix}restart
${branch}${LETT++} ${prefix}reload
${branch}${LETT++} ${prefix}update
${branch}${LETT++} >
${branch}${LETT++} =>
${branch}${LETT++} $
${left} 
...
const listMessage = {text: "Nakano-Bot Game",footer: `Selamat jawaban kamu benar🥳🎉\n\n[🎁]Kamu mendapatkan hadiah sebanyak ${htgm} Money\n\nTotal Money Kamu: ${getMonay(m.sender)}`, title: "List Game",buttonText: "Play Again",sections}
...
const sections = [ { title: "Game", rows: [ { title: "Kuis Math", rowId: "#math", description: "Kuis Matematika"},{title: "Tebak Gambar", rowId: "#tebakgambar", description: "Game Tebak Gambar"},{title: "Tebak Kimia", rowId: "#tebakkimia", description: "Game Tebak Kimia"},{title: "Asah Otak", rowId: "#asahotak", description: "Game Asahotak"}, {title: "Susun Kata", rowId: "#susunkata", description: "Game Susunkata"},{title: "Tebak Kalimat", rowId: "#tebakkalimat", description: "Game Tebak Kalimat"}, {title: "Teka Teki", rowId: "#tekateki", description: "Teka Teki"},{title: "Cak Lontong", rowId: "#caklontong", description: "Game Cak Lontong"}, { title: "Tebak Anime", rowId: "#tebakanime", description: "Game Tebak Anime"}, {title: "Tebak Kabupaten", rowId: "#tebakkabupaten", description: "Game Tebak Kabupaten"}, {title: "Tebak Bendera", rowId: "#tebakbendera", description: "Game Tebak Bendera"}, {title: "Tebak Lagu", rowId: "#tebaklagu", description: "Game Tebak Lagu"}, {title: "Tebak Lirik", rowId: "#tebaklirik", description: "Game Tebak Lirik"}, ]}    ]
const listMessage = {text: "Nakano-Bot Game",footer: `Selamat jawaban kamu benar🥳🎉\n\n[🎁]Kamu mendapatkan hadiah sebanyak ${_math[m.sender.split('@')[0]].monay} Money\n\nTotal Money Kamu: ${getMonay(m.sender)}`, title: "List Game",buttonText: "Play Again",sections}
const sendm =  sock.sendMessage( from, listMessage, {quoted :m })
...
const sections = [ { title: "Game", rows: [ { title: "Kuis Math", rowId: "#math", description: "Kuis Matematika"},{title: "Tebak Gambar", rowId: "#tebakgambar", description: "Game Tebak Gambar"},{title: "Tebak Kimia", rowId: "#tebakkimia", description: "Game Tebak Kimia"},{title: "Asah Otak", rowId: "#asahotak", description: "Game Asahotak"}, {title: "Susun Kata", rowId: "#susunkata", description: "Game Susunkata"},{title: "Tebak Kalimat", rowId: "#tebakkalimat", description: "Game Tebak Kalimat"}, {title: "Teka Teki", rowId: "#tekateki", description: "Teka Teki"},{title: "Cak Lontong", rowId: "#caklontong", description: "Game Cak Lontong"}, { title: "Tebak Anime", rowId: "#tebakanime", description: "Game Tebak Anime"}, {title: "Tebak Kabupaten", rowId: "#tebakkabupaten", description: "Game Tebak Kabupaten"}, {title: "Tebak Bendera", rowId: "#tebakbendera", description: "Game Tebak Bendera"}, {title: "Tebak Lagu", rowId: "#tebaklagu", description: "Game Tebak Lagu"}, {title: "Tebak Lirik", rowId: "#tebaklirik", description: "Game Tebak Lirik"}, ]}    ]
const listMessage = {text: "Nakano-Bot Game",footer: `Selamat jawaban kamu benar🥳🎉\n\n[🎁]Kamu mendapatkan hadiah sebanyak ${_tbkkimia[m.sender.split('@')[0]].monay} Money\n\nTotal Money Kamu: ${getMonay(m.sender)}`, title: "List Game",buttonText: "Play Again",sections}
const sendm =  sock.sendMessage( from, listMessage, {quoted :m })
...
const sections = [ { title: "Game", rows: [ { title: "Kuis Math", rowId: "#math", description: "Kuis Matematika"},{title: "Tebak Gambar", rowId: "#tebakgambar", description: "Game Tebak Gambar"},{title: "Tebak Kimia", rowId: "#tebakkimia", description: "Game Tebak Kimia"},{title: "Asah Otak", rowId: "#asahotak", description: "Game Asahotak"}, {title: "Susun Kata", rowId: "#susunkata", description: "Game Susunkata"},{title: "Tebak Kalimat", rowId: "#tebakkalimat", description: "Game Tebak Kalimat"}, {title: "Teka Teki", rowId: "#tekateki", description: "Teka Teki"},{title: "Cak Lontong", rowId: "#caklontong", description: "Game Cak Lontong"}, { title: "Tebak Anime", rowId: "#tebakanime", description: "Game Tebak Anime"}, {title: "Tebak Kabupaten", rowId: "#tebakkabupaten", description: "Game Tebak Kabupaten"}, {title: "Tebak Bendera", rowId: "#tebakbendera", description: "Game Tebak Bendera"}, {title: "Tebak Lagu", rowId: "#tebaklagu", description: "Game Tebak Lagu"}, {title: "Tebak Lirik", rowId: "#tebaklirik", description: "Game Tebak Lirik"}, ]}    ]
const listMessage = {text: "Nakano-Bot Game",footer: `Selamat jawaban kamu benar🥳🎉\n\n[🎁]Kamu mendapatkan hadiah sebanyak ${_asahotak[m.sender.split('@')[0]].monay} Money\n\nTotal Money Kamu: ${getMonay(m.sender)}`, title: "List Game",buttonText: "Play Again",sections}
const sendm =  sock.sendMessage( from, listMessage, {quoted :m })
...
const sections = [ { title: "Game", rows: [ { title: "Kuis Math", rowId: "#math", description: "Kuis Matematika"},{title: "Tebak Gambar", rowId: "#tebakgambar", description: "Game Tebak Gambar"},{title: "Tebak Kimia", rowId: "#tebakkimia", description: "Game Tebak Kimia"},{title: "Asah Otak", rowId: "#asahotak", description: "Game Asahotak"}, {title: "Susun Kata", rowId: "#susunkata", description: "Game Susunkata"},{title: "Tebak Kalimat", rowId: "#tebakkalimat", description: "Game Tebak Kalimat"}, {title: "Teka Teki", rowId: "#tekateki", description: "Teka Teki"},{title: "Cak Lontong", rowId: "#caklontong", description: "Game Cak Lontong"}, { title: "Tebak Anime", rowId: "#tebakanime", description: "Game Tebak Anime"}, {title: "Tebak Kabupaten", rowId: "#tebakkabupaten", description: "Game Tebak Kabupaten"}, {title: "Tebak Bendera", rowId: "#tebakbendera", description: "Game Tebak Bendera"}, {title: "Tebak Lagu", rowId: "#tebaklagu", description: "Game Tebak Lagu"}, {title: "Tebak Lirik", rowId: "#tebaklirik", description: "Game Tebak Lirik"}, ]}    ]
const listMessage = {text: "Nakano-Bot Game",footer: `Selamat jawaban kamu benar🥳🎉\n\n[🎁]Kamu mendapatkan hadiah sebanyak ${_susunkata[m.sender.split('@')[0]].monay} Money\n\nTotal Money Kamu: ${getMonay(m.sender)}`, title: "List Game",buttonText: "Play Again",sections}
const sendm =  sock.sendMessage( from, listMessage, {quoted :m })
...
const sections = [ { title: "Game", rows: [ { title: "Kuis Math", rowId: "#math", description: "Kuis Matematika"},{title: "Tebak Gambar", rowId: "#tebakgambar", description: "Game Tebak Gambar"},{title: "Tebak Kimia", rowId: "#tebakkimia", description: "Game Tebak Kimia"},{title: "Asah Otak", rowId: "#asahotak", description: "Game Asahotak"}, {title: "Susun Kata", rowId: "#susunkata", description: "Game Susunkata"},{title: "Tebak Kalimat", rowId: "#tebakkalimat", description: "Game Tebak Kalimat"}, {title: "Teka Teki", rowId: "#tekateki", description: "Teka Teki"},{title: "Cak Lontong", rowId: "#caklontong", description: "Game Cak Lontong"}, { title: "Tebak Anime", rowId: "#tebakanime", description: "Game Tebak Anime"}, {title: "Tebak Kabupaten", rowId: "#tebakkabupaten", description: "Game Tebak Kabupaten"}, {title: "Tebak Bendera", rowId: "#tebakbendera", description: "Game Tebak Bendera"}, {title: "Tebak Lagu", rowId: "#tebaklagu", description: "Game Tebak Lagu"}, {title: "Tebak Lirik", rowId: "#tebaklirik", description: "Game Tebak Lirik"}, ]}    ]
const listMessage = {text: "Nakano-Bot Game",footer: `Selamat jawaban kamu benar🥳🎉\n\n[🎁]Kamu mendapatkan hadiah sebanyak ${_tebakkalimat[m.sender.split('@')[0]].monay} Money\n\nTotal Money Kamu: ${getMonay(m.sender)}`, title: "List Game",buttonText: "Play Again",sections}
const sendm =  sock.sendMessage( from, listMessage, {quoted :m })
...
const sections = [ { title: "Game", rows: [ { title: "Kuis Math", rowId: "#math", description: "Kuis Matematika"},{title: "Tebak Gambar", rowId: "#tebakgambar", description: "Game Tebak Gambar"},{title: "Tebak Kimia", rowId: "#tebakkimia", description: "Game Tebak Kimia"},{title: "Asah Otak", rowId: "#asahotak", description: "Game Asahotak"}, {title: "Susun Kata", rowId: "#susunkata", description: "Game Susunkata"},{title: "Tebak Kalimat", rowId: "#tebakkalimat", description: "Game Tebak Kalimat"}, {title: "Teka Teki", rowId: "#tekateki", description: "Teka Teki"},{title: "Cak Lontong", rowId: "#caklontong", description: "Game Cak Lontong"}, { title: "Tebak Anime", rowId: "#tebakanime", description: "Game Tebak Anime"}, {title: "Tebak Kabupaten", rowId: "#tebakkabupaten", description: "Game Tebak Kabupaten"}, {title: "Tebak Bendera", rowId: "#tebakbendera", description: "Game Tebak Bendera"}, {title: "Tebak Lagu", rowId: "#tebaklagu", description: "Game Tebak Lagu"}, {title: "Tebak Lirik", rowId: "#tebaklirik", description: "Game Tebak Lirik"}, ]}    ]
const listMessage = {text: "Nakano-Bot Game",footer: `Selamat jawaban kamu benar🥳🎉\n\n[🎁]Kamu mendapatkan hadiah sebanyak ${_tekateki[m.sender.split('@')[0]].monay} Money\n\nTotal Money Kamu: ${getMonay(m.sender)}`, title: "List Game",buttonText: "Play Again",sections}
const sendm =  sock.sendMessage( from, listMessage, {quoted :m })
...
const sections = [ { title: "Game", rows: [ { title: "Kuis Math", rowId: "#math", description: "Kuis Matematika"},{title: "Tebak Gambar", rowId: "#tebakgambar", description: "Game Tebak Gambar"},{title: "Tebak Kimia", rowId: "#tebakkimia", description: "Game Tebak Kimia"},{title: "Asah Otak", rowId: "#asahotak", description: "Game Asahotak"}, {title: "Susun Kata", rowId: "#susunkata", description: "Game Susunkata"},{title: "Tebak Kalimat", rowId: "#tebakkalimat", description: "Game Tebak Kalimat"}, {title: "Teka Teki", rowId: "#tekateki", description: "Teka Teki"},{title: "Cak Lontong", rowId: "#caklontong", description: "Game Cak Lontong"}, { title: "Tebak Anime", rowId: "#tebakanime", description: "Game Tebak Anime"}, {title: "Tebak Kabupaten", rowId: "#tebakkabupaten", description: "Game Tebak Kabupaten"}, {title: "Tebak Bendera", rowId: "#tebakbendera", description: "Game Tebak Bendera"}, {title: "Tebak Lagu", rowId: "#tebaklagu", description: "Game Tebak Lagu"}, {title: "Tebak Lirik", rowId: "#tebaklirik", description: "Game Tebak Lirik"}, ]}    ]
const listMessage = {text: "Nakano-Bot Game",footer: `Selamat jawaban kamu benar🥳🎉\n\n[🎁]Kamu mendapatkan hadiah sebanyak ${_caklontong[m.sender.split('@')[0]].monay} Money\n\nTotal Money Kamu: ${getMonay(m.sender)}`, title: "List Game",buttonText: "Play Again",sections}
const sendm =  sock.sendMessage( from, listMessage, {quoted :m })
...
const sections = [ { title: "Game", rows: [ { title: "Kuis Math", rowId: "#math", description: "Kuis Matematika"},{title: "Tebak Gambar", rowId: "#tebakgambar", description: "Game Tebak Gambar"},{title: "Tebak Kimia", rowId: "#tebakkimia", description: "Game Tebak Kimia"},{title: "Asah Otak", rowId: "#asahotak", description: "Game Asahotak"}, {title: "Susun Kata", rowId: "#susunkata", description: "Game Susunkata"},{title: "Tebak Kalimat", rowId: "#tebakkalimat", description: "Game Tebak Kalimat"}, {title: "Teka Teki", rowId: "#tekateki", description: "Teka Teki"},{title: "Cak Lontong", rowId: "#caklontong", description: "Game Cak Lontong"}, { title: "Tebak Anime", rowId: "#tebakanime", description: "Game Tebak Anime"}, {title: "Tebak Kabupaten", rowId: "#tebakkabupaten", description: "Game Tebak Kabupaten"}, {title: "Tebak Bendera", rowId: "#tebakbendera", description: "Game Tebak Bendera"}, {title: "Tebak Lagu", rowId: "#tebaklagu", description: "Game Tebak Lagu"}, {title: "Tebak Lirik", rowId: "#tebaklirik", description: "Game Tebak Lirik"}, ]}    ]
const listMessage = {
text: "Nakano-Bot Game",
footer: `Selamat jawaban kamu benar🥳🎉\n\n[🎁]Kamu mendapatkan hadiah sebanyak ${_tebakbendera[m.sender.split('@')[0]].monay} Money\n\nTotal Money Kamu: ${getMonay(m.sender)}`, 
title: "List Game",
...
const sections = [ { title: "Game", rows: [ { title: "Kuis Math", rowId: "#math", description: "Kuis Matematika"},{title: "Tebak Gambar", rowId: "#tebakgambar", description: "Game Tebak Gambar"},{title: "Tebak Kimia", rowId: "#tebakkimia", description: "Game Tebak Kimia"},{title: "Asah Otak", rowId: "#asahotak", description: "Game Asahotak"}, {title: "Susun Kata", rowId: "#susunkata", description: "Game Susunkata"},{title: "Tebak Kalimat", rowId: "#tebakkalimat", description: "Game Tebak Kalimat"}, {title: "Teka Teki", rowId: "#tekateki", description: "Teka Teki"},{title: "Cak Lontong", rowId: "#caklontong", description: "Game Cak Lontong"}, { title: "Tebak Anime", rowId: "#tebakanime", description: "Game Tebak Anime"}, {title: "Tebak Kabupaten", rowId: "#tebakkabupaten", description: "Game Tebak Kabupaten"}, {title: "Tebak Bendera", rowId: "#tebakbendera", description: "Game Tebak Bendera"}, {title: "Tebak Lagu", rowId: "#tebaklagu", description: "Game Tebak Lagu"}, {title: "Tebak Lirik", rowId: "#tebaklirik", description: "Game Tebak Lirik"}, ]}    ]
const listMessage = {text: "Nakano-Bot Game",footer: `Selamat jawaban kamu benar🥳🎉\n\n[🎁]Kamu mendapatkan hadiah sebanyak ${_tebakanime[m.sender.split('@')[0]].monay} Money\n\nTotal Money Kamu: ${getMonay(m.sender)}`, title: "List Game",buttonText: "Play Again",sections
   }
const sendm =  sock.sendMessage( from, listMessage, {quoted :m })
...
const sections = [ { title: "Game", rows: [ { title: "Kuis Math", rowId: "#math", description: "Kuis Matematika"},{title: "Tebak Gambar", rowId: "#tebakgambar", description: "Game Tebak Gambar"},{title: "Tebak Kimia", rowId: "#tebakkimia", description: "Game Tebak Kimia"},{title: "Asah Otak", rowId: "#asahotak", description: "Game Asahotak"}, {title: "Susun Kata", rowId: "#susunkata", description: "Game Susunkata"},{title: "Tebak Kalimat", rowId: "#tebakkalimat", description: "Game Tebak Kalimat"}, {title: "Teka Teki", rowId: "#tekateki", description: "Teka Teki"},{title: "Cak Lontong", rowId: "#caklontong", description: "Game Cak Lontong"}, { title: "Tebak Anime", rowId: "#tebakanime", description: "Game Tebak Anime"}, {title: "Tebak Kabupaten", rowId: "#tebakkabupaten", description: "Game Tebak Kabupaten"}, {title: "Tebak Bendera", rowId: "#tebakbendera", description: "Game Tebak Bendera"}, {title: "Tebak Lagu", rowId: "#tebaklagu", description: "Game Tebak Lagu"}, {title: "Tebak Lirik", rowId: "#tebaklirik", description: "Game Tebak Lirik"}, ]}    ]
const listMessage = {text: "Nakano-Bot Game",footer: `Selamat jawaban kamu benar🥳🎉\n\n[🎁]Kamu mendapatkan hadiah sebanyak ${_tebakkabupaten[m.sender.split('@')[0]].monay} Money\n\nTotal Money Kamu: ${getMonay(m.sender)}`, title: "List Game",buttonText: "Play Again",sections}
const sendm =  sock.sendMessage( from, listMessage, {quoted :m })
...
const sections = [ { title: "Game", rows: [ { title: "Kuis Math", rowId: "#math", description: "Kuis Matematika"},{title: "Tebak Gambar", rowId: "#tebakgambar", description: "Game Tebak Gambar"},{title: "Tebak Kimia", rowId: "#tebakkimia", description: "Game Tebak Kimia"},{title: "Asah Otak", rowId: "#asahotak", description: "Game Asahotak"}, {title: "Susun Kata", rowId: "#susunkata", description: "Game Susunkata"},{title: "Tebak Kalimat", rowId: "#tebakkalimat", description: "Game Tebak Kalimat"}, {title: "Teka Teki", rowId: "#tekateki", description: "Teka Teki"},{title: "Cak Lontong", rowId: "#caklontong", description: "Game Cak Lontong"}, { title: "Tebak Anime", rowId: "#tebakanime", description: "Game Tebak Anime"}, {title: "Tebak Kabupaten", rowId: "#tebakkabupaten", description: "Game Tebak Kabupaten"}, {title: "Tebak Bendera", rowId: "#tebakbendera", description: "Game Tebak Bendera"}, {title: "Tebak Lagu", rowId: "#tebaklagu", description: "Game Tebak Lagu"}, {title: "Tebak Lirik", rowId: "#tebaklirik", description: "Game Tebak Lirik"}, ]}    ]
const listMessage = {text: "Nakano-Bot Game",footer: `Selamat jawaban kamu benar🥳🎉\n\n[🎁]Kamu mendapatkan hadiah sebanyak ${_tebaklirik[m.sender.split('@')[0]].monay} Money\n\nTotal Money Kamu: ${getMonay(m.sender)}`, title: "List Game",buttonText: "Play Again",sections}
const sendm =  sock.sendMessage( from, listMessage, {quoted :m })
...
const sections = [ { title: "Game", rows: [ { title: "Kuis Math", rowId: "#math", description: "Kuis Matematika"},{title: "Tebak Gambar", rowId: "#tebakgambar", description: "Game Tebak Gambar"},{title: "Tebak Kimia", rowId: "#tebakkimia", description: "Game Tebak Kimia"},{title: "Asah Otak", rowId: "#asahotak", description: "Game Asahotak"}, {title: "Susun Kata", rowId: "#susunkata", description: "Game Susunkata"},{title: "Tebak Kalimat", rowId: "#tebakkalimat", description: "Game Tebak Kalimat"}, {title: "Teka Teki", rowId: "#tekateki", description: "Teka Teki"},{title: "Cak Lontong", rowId: "#caklontong", description: "Game Cak Lontong"}, { title: "Tebak Anime", rowId: "#tebakanime", description: "Game Tebak Anime"}, {title: "Tebak Kabupaten", rowId: "#tebakkabupaten", description: "Game Tebak Kabupaten"}, {title: "Tebak Bendera", rowId: "#tebakbendera", description: "Game Tebak Bendera"}, {title: "Tebak Lagu", rowId: "#tebaklagu", description: "Game Tebak Lagu"}, {title: "Tebak Lirik", rowId: "#tebaklirik", description: "Game Tebak Lirik"}, ]}    ]
const listMessage = {text: "Nakano-Bot Game",footer: `Selamat jawaban kamu benar🥳🎉\n\n[🎁]Kamu mendapatkan hadiah sebanyak ${_tebaklagu[m.sender.split('@')[0]].monay} Money\n\nTotal Money Kamu: ${getMonay(m.sender)}`, title: "List Game",buttonText: "Play Again",sections}
const sendm =  sock.sendMessage( from, listMessage, {quoted :m })
  ...
  case 'menu2':{  
   let button = [{
     index: 1, 
      urlButton: {
       ...
       url: 'https://github.com/DarrenM999'
       } 
     },     
     {
     index: 2, 
   ...
   let buttonss = [{
     index: 1, 
      urlButton: {
       displayText: '𝚈𝙾𝚄𝚃𝚄𝙱𝙴', 
       url: 'https://youtube.com/c/RenmaMV'
       } 
     },     
     {
      index: 1, 
       ...
       url: 'https://www.instagram.com/darren_m.j.j'
       }
       }, 
       {
       index: 1, 
       urlButton: {
       displayText: '𝙳𝙸𝚂𝙲𝙾𝚁𝙳', 
       url: 'https://discord.io/NakanoCommunity'
       }
       }, 
       {
     index: 2, 
    ...
    from, 
    MenuList,
    `If you are confused with the following command.\nYou can add --help to view information about the command!\n𝗘𝘅𝗮𝗺𝗽𝗹𝗲 : #sticker --help`, 
    buttonss, 
    thumb, 
    await m.createMsg(
     from, 
